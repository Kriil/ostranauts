...
internal static class BonusAirlock
{
	...
	public static void ApplyBonuses(Room room)
	{
		...
		if (hasScrubber)
		{
			RoomEffectUtils.LogRoomEffect($"Setting Airlock Scrubber Speed Bonus of {Plugin.AirlockScrubberSpeedBonus.Value * 100f}% due to scrubber device installed in room.", "Airlock", room);
		} else {
