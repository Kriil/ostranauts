...
namespace FFU_Beyond_Reach {
    public static partial class FFU_BR_APIs {
        public static readonly Version FFU_BR_Core;
    }

    public static partial class FFU_BR_Defs {
        ...
        public static float[] OrgInventoryTweaks = [0.5f, -35f, 0f, 0f];
        public static bool BetterInvTransfer = true;
        public static bool QuickBarPinning = false;
        public static float[] QuickBarTweaks = [-495f, 340f, 1f];
        ...
        public static string[] SuperCharacters = ["Exact Char Name One", "Exact Char Name Two"];
        ...
        public static void InitConfig() {
            ...
            JsonLogging = ModDefs.Bind("ConfigSettings", "JsonLogging", JsonLogging,
                "Defines if JSON parsing errors will be shown in the log during loading.").Value;
            ...
            string refOrgInvString = ModDefs.Bind("QualitySettings", "OrgInventoryTweaks", 
                ...
                "Inventory offsets for tweaking: Top Offset, Bottom Limit, " +
                "Horizontal Padding, Vertical Padding.").Value;
            if (refOrgInvString.Split('|').Length == 4) OrgInventoryTweaks = Array.ConvertAll(
    ...
    public static class VersionHelpers {
        public static bool GT(this Version v1, Version v2) => v1.CompareTo(v2) > 0;
        public static bool GE(this Version v1, Version v2) => v1.CompareTo(v2) >= 0;
        public static bool LT(this Version v1, Version v2) => v1.CompareTo(v2) < 0;
        public static bool LE(this Version v1, Version v2) => v1.CompareTo(v2) <= 0;
        public static bool EQ(this Version v1, Version v2) => v1.Equals(v2);
        public static bool NE(this Version v1, Version v2) => !v1.Equals(v2);
    }
}