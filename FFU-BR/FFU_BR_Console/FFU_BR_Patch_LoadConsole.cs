...
public static bool ResolveString(ref string strInput)
{
	...
	case "tutorial":
		return KeywordAddTutorial(ref strInput, array);
	case "stopTutorial":
		return KeywordStopTutorial(ref strInput, array);
	case "stop":
		return KeywordStopTutorial(ref strInput, array);
	case "complete":
		return KeywordCompleteTutorial(ref strInput, array);
	case "pda":
		return KeywordPDA(ref strInput, array);
	case "rename":
