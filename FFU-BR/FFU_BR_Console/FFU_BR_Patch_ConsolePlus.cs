...
public partial class patch_ConsoleToGUI : ConsoleToGUI {
    ...
    [MonoModReplace] private void DrawConsole(int window) {
        ...
        Rect textView = new(10f, 20f, Screen.width / 2 - 40, mChars / 4);
        Rect scrollView = new(10f, 30f, Screen.width / 2 - 20, Screen.height / 2 - (_textActual + 55f));
        Rect textField = new(10f, scrollView.y + scrollView.height + 5f, Screen.width / 2 - 40, _textActual + 10f);
