...
namespace SFB
{
	public class StandaloneFileBrowserWindows : IStandaloneFileBrowser
	{
		...
		public string[] OpenFilePanel(string title, string directory, ExtensionFilter[] extensions, bool multiselect)
		{
			...
			DialogResult dialogResult = vistaOpenFileDialog.ShowDialog(new WindowWrapper(StandaloneFileBrowserWindows.GetActiveWindow()));
		...
		public string[] OpenFolderPanel(string title, string directory, bool multiselect)
		{
			...
			DialogResult dialogResult = vistaFolderBrowserDialog.ShowDialog(new WindowWrapper(StandaloneFileBrowserWindows.GetActiveWindow()));
			string[] array;
		...
		public string SaveFilePanel(string title, string directory, string defaultName, ExtensionFilter[] extensions)
		{
			...
			DialogResult dialogResult = vistaSaveFileDialog.ShowDialog(new WindowWrapper(StandaloneFileBrowserWindows.GetActiveWindow()));
